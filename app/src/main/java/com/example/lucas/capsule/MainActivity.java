...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Chama a Classe ClienteDAO para executar o metodo Salvar
        ...
        // Se vier um cliene no intent que disparou a activity, ele abre a tela de edição ao invés de Lista
        ...
        configurarRecycler(); // Método configurarRecycler lá de baixo
    }
    ...
    // integração da RecyclerView com os dados da ClienteDAO
    RecyclerView recyclerView;
    ClienteAdapter adapter;

    // Método para que seja disparado e popule Inicialmente a RecyclerView com a Lista de cliente
    ...
    // Variavel usada para guardar o cliente que será editado
